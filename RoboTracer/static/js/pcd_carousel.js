// pcd Carousel with Infinite Loop and Debounce
document.addEventListener('DOMContentLoaded', function() {
    const track = document.getElementById('pcdCarouselTrack');
    const prevBtn = document.getElementById('pcdPrevBtn');
    const nextBtn = document.getElementById('pcdNextBtn');
    const dots = document.querySelectorAll('.pcd-carousel-dots .dot');
    const slides = document.querySelectorAll('.pcd-carousel-slide');
