// robotwin Carousel with Infinite Loop and Debounce
document.addEventListener('DOMContentLoaded', function() {
    const track = document.getElementById('robotwinCarouselTrack');
    const prevBtn = document.getElementById('robotwinPrevBtn');
    const nextBtn = document.getElementById('robotwinNextBtn');
    const dots = document.querySelectorAll('.robotwin-carousel-dots .dot');
    const slides = document.querySelectorAll('.robotwin-carousel-slide');
